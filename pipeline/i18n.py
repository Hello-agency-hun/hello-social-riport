...
STRINGS = {
    "hu": {
        ...
        "no_stable_baseline": "nem viszonyítható",
        ...
        "essentials_month_in_numbers": "A hónap számokban",
        "essentials_published": "Kiküldött tartalom",
        "essentials_ad_spend": "Hirdetési költés",
        "essentials_boosted_posts": "Ebből támogatott poszt",
        "essentials_next_steps": "Következő lépések",
        "vs_previous_month": "az előző hónaphoz",
        ...
        "shares": "Megosztás",
        "followers": "Követő",
        "new_followers_label": "Új követő",
        "from_measured_posts": "a mért posztokból",
        "page_level": "az oldal egészéről",
        "organic_label": "organikus",
        "paid_label": "hirdetett",
        "interactions_ranked": "Sorrend az interakciók szerint; az elérés is látszik.",
        "saves": "Mentés",
        ...
        "campaign_status_eyebrow": "Kampányállapotok",
        "campaign_status_title": "Mi futott, és mi zárult le?",
        "campaign_status_body": "Az állapotok és eredmények közvetlenül a Meta-exportból származnak.",
        "campaign_end": "Vége",
        "campaign_result": "Elsődleges eredmény",
        "campaign_report_window": "Meta-export lekérési időszaka",
        "campaign_ongoing": "folyamatban",
        "campaign_active": "aktív",
        "campaign_completed": "lezárult",
        "campaign_paused": "szünetel",
        "campaign_unknown": "nincs adat",
        "ads_exact_label": "pontos Ads-időszak",
        "ads_indicative_label": "tájékoztató Ads-adatok",
        "ads_indicative_body": "A Meta Ads export más időszakot fed, ezért az itt látható teljes Ads-összegek tájékoztató jellegűek; nem arányosítottuk őket.",
        "period_gap_warning": "A mérési időszakban kihagyott nap van, ezért ez az összehasonlítás nem tekinthető hitelesnek.",
        "period_overlap_warning": "A mérési időszak átfed az előző riporttal, ezért az összehasonlítás torzíthat.",
        "period_nonstandard_warning": "A kiválasztott időszak eltér a havi mérés szokásos hosszától, ezért az eredmény nem teljes értékű havi összehasonlítás.",
        "period_assumed_warning": "A pontos mérési dátumok nem voltak megadva vagy kiolvashatók; a riport naptári hónapot feltételez.",
        # boost értéke
        ...
        "footer_note": "— pontos, mindkét határnapot tartalmazó mérési időszak. Az "
    ...
    "en": {
        ...
        "no_stable_baseline": "not comparable",
        ...
        "essentials_month_in_numbers": "The month in numbers",
        "essentials_published": "Content published",
        "essentials_ad_spend": "Ad spend",
        "essentials_boosted_posts": "Of which boosted",
        "essentials_next_steps": "Next steps",
        ...
        "shares": "Shares",
        "followers": "Followers",
        "new_followers_label": "New followers",
        "from_measured_posts": "from measured posts",
        "page_level": "page level",
        "organic_label": "organic",
        "paid_label": "boosted",
        "interactions_ranked": "Ranked by interactions; reach is shown alongside.",
        "saves": "Saves",
        ...
        "campaign_status_eyebrow": "Campaign status",
        "campaign_status_title": "What was running, and what ended?",
        "campaign_status_body": "Statuses and results come directly from the Meta export.",
        "campaign_end": "End",
        "campaign_result": "Primary result",
        "campaign_report_window": "Meta export query period",
        "campaign_ongoing": "ongoing",
        "campaign_active": "active",
        "campaign_completed": "completed",
        "campaign_paused": "paused",
        "campaign_unknown": "not available",
        "ads_exact_label": "exact Ads period",
        "ads_indicative_label": "indicative Ads data",
        "ads_indicative_body": "The Meta Ads export covers a different period, so the full Ads totals shown here are indicative; they have not been prorated.",
        "period_gap_warning": "The measurement period contains a gap, so this comparison cannot be considered reliable.",
        "period_overlap_warning": "The measurement period overlaps the previous report, which may distort the comparison.",
        "period_nonstandard_warning": "The selected range differs from the usual monthly measurement length, so it is not a like-for-like monthly comparison.",
        "period_assumed_warning": "Exact measurement dates were not supplied or detectable; the report assumes a calendar month.",
        ...
        "footer_note": "— an exact inclusive measurement period. Data comes from "
        "the official Meta Business Suite and ZoomSphere exports.",
